    ...
    <>
      ...
      <section style={{ paddingTop: '150px' }}>
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <p>
            <strong>Last updated</strong> <strong>July 12, 2022</strong>
          </p>
          ...
          <p>
            <a href="#payment">5. FEES AND PAYMENT</a>
          </p>
          <p>
            <a href="#freetrial">6. FREE TRIAL</a>
          </p>
          <p>
            <a href="#cancel">7. CANCELLATION</a>
          </p>
          <p>
          ...
          <p>
            <a href="#reviews">11. GUIDELINES FOR REVIEWS</a>
          </p>
          <p>
            <a href="#mobile">12. MOBILE APPLICATION LICENSE</a>
          </p>
          <p>
            <a href="#socialmedia">13. SOCIAL MEDIA</a>
          </p>
          <p>
            <a href="#submissions">14. SUBMISSIONS</a>
          </p>
          <p>
            <a href="#usrights">15. U.S. GOVERNMENT RIGHTS</a>
          </p>
          <p>
            <a href="#sitemanage">16. SITE MANAGEMENT</a>
          </p>
          <p>
            <a href="#privacypolicy1">17. PRIVACY POLICY</a>
          </p>
          <p>
            <a href="#dmca">
          ...
          <p>
            <a href="#terms">19. TERM AND TERMINATION</a>
          </p>
          <p>
            <a href="#modifications">20. MODIFICATIONS AND INTERRUPTIONS</a>
          </p>
          <p>
            <a href="#law">21. GOVERNING LAW</a>
          </p>
          <p>
            <a href="#disputes">22. DISPUTE RESOLUTION</a>
          </p>
          <p>
            <a href="#corrections">23. CORRECTIONS</a>
          </p>
          <p>
            <a href="#disclaimer">24. DISCLAIMER</a>
          </p>
          <p>
            <a href="#liability">25. LIMITATIONS OF LIABILITY</a>
          </p>
          <p>
            <a href="#indemnification">26. INDEMNIFICATION</a>
          </p>
          <p>
            <a href="#userdata">27. USER DATA</a>
          </p>
          <p>
            <a href="#electronic">
          ...
          <p>
            <a href="#california">29. CALIFORNIA USERS AND RESIDENTS</a>
          </p>
          <p>
            <a href="#misc">30. MISCELLANEOUS</a>
          </p>
          <p>
          ...
          <p>
            ...
            and Facets LLC, doing business as Facets (“<strong>Facets</strong>“,
            “<strong>we</strong>”, “<strong>us</strong>”, or “
            <strong>our</strong>”), concerning your access to and use of the{' '}
            <a href="http://www.facets.one">http://www.facets.one</a> website as
            ...
            States and have our registered office at 1 Daniel Burnham Court, apt
            106, San Francisco, CA 94109. You agree that by accessing the Site,
          ...
          <ul>
            ...
            <li>
              To misrepresent your identity, your age, your current or previous
              positions, qualifications or affiliations with a person or entity
            </li>
            <li>
              To disclose information that you do not have the consent to
              disclose.
            </li>
            <li>To spam, solicit money from or defraud any members.</li>
            <li>
              To develop, support or use software, devices, scripts, robots,
            ...
            <li>
              To create another account if we have already terminated your
              account, unless you have our permission
            </li>
            <li>
              To break any applicable laws, and/or violate or infringes on
              anyone’s rights, including rights of publicity, privacy,
              copyright, trademark or other intellectual property or contract
              right.
            </li>
            <li>
              To post any photo, video, audio or text that promotes racism,
              bigotry, hatred or physical harm of any kind against any group or
              individual.
            </li>
            <li>
              To post any photo, video, audio or text that is hate speech,
              threatening, sexually explicit or pornographic.
            </li>
            <li>To impersonate any person or entity.</li>
            <li>
              To use the service to harm or damage any person, entity or
              organization including Facets.
            </li>
          </ul>
          <h2 id="ugc">
          ...
          <h3 id="-apple-and-android-devices-">
          ...
          <h2 id="usrights">
            <strong>15. U.S. GOVERNMENT RIGHTS</strong>
          </h2>
          <p>
          ...
          <h2 id="sitemanage-">
            <strong>16. SITE MANAGEMENT</strong>
          </h2>
          <p>
          ...
          <p>
            ...
            Policy:{' '}
            <strong>
              <a href="https://facets.one/privacy/">
                https://facets.one/privacy/
              </a>
            </strong>
          ...
          <p>
            ...
            below (a “Notification”). A copy of your Notification will be sent
            ...
            on or linked to by the Site infringes your copyright, you should
          ...
          <p>
            ...
            contacted; (5) a statement that the complaining party has a good
          ...
          <p>
            ...
            <a href="http://www.adr.org">www.adr.org</a>. Your arbitration fees
            ...
            United States, California. Except as otherwise provided herein, the
          ...
          <p>
            ...
            state and federal courts located in United States, California, and
          ...
          <h3 id="-exceptions-to-informal-negotiations-and-arbitration-">
          ...
          <h2 id="california">
            <strong>29. CALIFORNIA USERS AND RESIDENTS</strong>
          </h2>
          <p>
          ...
          <p>
            <strong>Unit #523</strong>
          </p>
          <p>
            <strong>San Francisco, CA 94121</strong>
          </p>
          <p>
