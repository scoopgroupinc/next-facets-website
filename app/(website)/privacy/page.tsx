    ...
    <>
      ...
      <section style={{ paddingTop: '150px' }}>
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <p>
            <strong>Last updated July 03, 2022</strong>
          </p>
          <p>
            This privacy notice for Facets LLC (doing business as Facets) (“
            <strong>Facets</strong>,” “<strong>we</strong>,” “
          ...
          <ul>
            <li>
              <p>
                ...
                <a href="http://www.facets.one">http://www.facets.one</a>, or
                any website of ours that links to this privacy notice
              </p>
            </li>
            <li>
              <p>
                Download and use our mobile application (Facets), or any other
          ...
          <p>
            ...
            contact us at natalie@facets.one.
          </p>
          <h2>
          ...
          <p>
            ...
            information depending on how you interact with Facets and the
          ...
          <p>
            ...
            <a href="#sensitiveinfo">here</a> to learn more.
          </p>
          <p>
          ...
          <p>
            ...
            categories of third parties. Click <a href="#whoshare">here</a> to
            learn more.
          </p>
          <p>
          ...
          <p>
            ...
            available{' '}
            <a href="https://app.termly.io/notify/1b9fadd6-d915-4e56-b2b0-794aa59417d7">
              here
            </a>
          ...
          <p>
            Want to learn more about what Facets does with any information we
          ...
          <ul>
            <li>
              <p>data about a person’s sex life or sexual orientation</p>
            </li>
            <li>
              <p>information revealing race or ethnic origin</p>
            </li>
            <li>
              <p>information revealing political opinions</p>
            </li>
            <li>
              <p>information revealing religious or philosophical beliefs</p>
            </li>
            <li>
              <p>student data</p>
            </li>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                including your mobile device’s contacts, camera, microphone, sms
                messages, social media accounts, bluetooth, calendar, reminders,
                sensors, storage, and other features. If you wish to change our
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                .** To communicate with individuals who submitted reports and to
                use information to needed to find violators and to improve user
                security and safety.
              </p>
            </li>
          </ul>
          ...
          <ul>
            <li>
              <p>
                ...
                consent at any time. Click <a href="#withdrawconsent">here</a>{' '}
                to learn more.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>protect our Users and third parties from harm</p>
            </li>
            <li>
              <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                <a href="https://policies.google.com/privacy">link</a>. We use
                certain Google Maps Platform APIs to retrieve certain
                information when you make location-specific requests. This
                includes: city location; and other similar information. A full
                list of what we use information for can be found in this section
                and in the previous section titled “
                <a href="#infouse">HOW DO WE PROCESS YOUR INFORMATION?</a>“. We
          ...
          <p>
            ...
            age 18, please contact us at admin@facets.one.
          </p>
          <h3 id="privacyrights">
          ...
          <p>
            Facets LLC collects and shares your personal information through:
          </p>
          <ul>
            <li>
          ...
          <p>
            You may contact us by email at admin@facets.one, by visiting{' '}
            <a href="http://www.facets.one/contact-us">
              http://www.facets.one/contact-us
            </a>
          ...
          <p>
            Facets LLC has not sold any personal information to third parties
            for a business or commercial purpose in the preceding twelve (12)
            months. Facets LLC has disclosed the following categories of
          ...
          <ul>
            ...
            <li>
              <p>Category G. Geolocation data, such as device location.</p>
            </li>
            <li>
              <p>
                Category H. Audio, electronic, visual, and similar information,
                such as images and audio, video, or call recordings created in
                connection with our business activities.
              </p>
            </li>
            <li>
              <p>
                Category I. Professional or employment-related information, such
                as business contact details in order to provide you our services
            ...
            <li>
              <p>
                Category J. Education information, such as student records and
          ...
          <p>
            ...
            us at admin@facets.oneor by post to:
          </p>
          <p>Facets LLC</p>
