    ...
    <>
      ...
      <section>
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <ul>
            <li><p>Visit our website at <a href="http://www.facets.one">http://www.facets.one</a>, or any website of ours that links to this privacy notice</p>
            </li>
            <li><p>Download and use our mobile application (Facets), or any other application of ours that links to this privacy notice</p>
            </li>
            <li><p>Engage with us in other related ways, including any sales, marketing, or events</p>
            </li>
            </ul>
            <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at natalie@facets.one.</p>
            ...
            <p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Facets and the Services, the choices you make, and the products and features you use. Click <a href="#personalinfo">here</a> to learn more.</p>
            <p><strong>Do we process any sensitive personal information?</strong> We may process sensitive personal information when necessary with your consent or as otherwise permitted by applicable law. Click <a href="#sensitiveinfo">here</a> to learn more.</p>
            ...
            <p><strong>In what situations and with which types of parties do we share personal information?</strong> We may share information in specific situations and with specific categories of third parties. Click <a href="#whoshare">here</a> to learn more.</p>
            ...
            <p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by filling out our data subject request form available <a href="https://app.termly.io/notify/1b9fadd6-d915-4e56-b2b0-794aa59417d7">here</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
            <p>Want to learn more about what Facets does with any information we collect? Click <a href="#toc">here</a> to review the notice in full.</p>
            ...
            <h3 id="infocollect" ><strong>1. WHAT INFORMATION DO WE COLLECT?</strong></h3>
            ...
            <li><p>contact or authentication data</p>
            </li>
            <li><p>billing addresses</p>
            </li>
            ...
            <ul>
            <li><p>data about a person’s sex life or sexual orientation</p>
            </li>
            <li><p>information revealing race or ethnic origin</p>
            </li>
            <li><p>information revealing political opinions</p>
            </li>
            <li><p>information revealing religious or philosophical beliefs</p>
            </li>
            <li><p>student data</p>
            </li>
            <li><p>credit worthiness data</p>
            </li>
            <li><p>biometric data</p>
            </li>
            <li><p>health data</p>
            </li>
            ...
            <ul>
            <li><p><em>Geolocation Information.</em> We may request access or permission to track location-based information from your mobile device, either continuously or while you are using our mobile application(s), to provide certain location-based services. If you wish to change our access or permissions, you may do so in your device’s settings.</p>
            </li>
            <li><p><em>Mobile Device Access.</em> We may request access or permission to certain features from your mobile device, including your mobile device’s contacts, camera, microphone, sms messages, social media accounts, bluetooth, calendar, reminders, sensors, storage, and other features. If you wish to change our access or permissions, you may do so in your device’s settings.</p>
            </li>
            <li><p><em>Mobile Device Data.</em> We automatically collect device information (such as your mobile device ID, model, and manufacturer), operating system, version information and system configuration information, device and application identification numbers, browser type and version, hardware model Internet service provider and/or mobile carrier, and Internet Protocol (IP) address (or proxy server). If you are using our application(s), we may also collect information about the phone network associated with your mobile device, your mobile device’s operating system or platform, the type of mobile device you use, your mobile device’s unique device ID, and information about the features of our application(s) you accessed.</p>
            </li>
            <li><p><em>Push Notifications.</em> We may request to send you push notifications regarding your account or certain features of the application(s). If you wish to opt out from receiving these types of communications, you may turn them off in your device’s settings.</p>
            </li>
            </ul>
            ...
            <ul>
            <li><p><em>Log and Usage Data.</em> Log and usage data is service-related, diagnostic, usage, and performance information our servers automatically collect when you access or use our Services and which we record in log files. Depending on how you interact with us, this log data may include your IP address, device information, browser type, and settings and information about your activity in the Services (such as the date/time stamps associated with your usage, pages and files viewed, searches, and other actions you take such as which features you use), device event information (such as system activity, error reports (sometimes called “crash dumps”), and hardware settings).</p>
            </li>
            ...
            <h3 id="infouse"><strong>2. HOW DO WE PROCESS YOUR INFORMATION?</strong></h3>
            ...
            <ul>
            <li><p><strong>To facilitate account creation and authentication and otherwise manage user accounts.</strong> We may process your information so you can create and log in to your account, as well as keep your account in working order.</p>
            </li>
            <li><p><strong>To deliver and facilitate delivery of services to the user.</strong> We may process your information to provide you with the requested service.</p>
            </li>
            <li><p><strong>To respond to user inquiries/offer support to users.</strong> We may process your information to respond to your inquiries and solve any potential issues you might have with the requested service.</p>
            </li>
            <li><p><strong>To send administrative information to you.</strong> We may process your information to send you details about our products and services, changes to our terms and policies, and other similar information.</p>
            </li>
            <li><p><strong>To fulfill and manage your orders.</strong> We may process your information to fulfill and manage your orders, payments, returns, and exchanges made through the Services.</p>
            </li>
            <li><p><strong>To enable user-to-user communications.</strong> We may process your information if you choose to use any of our offerings that allow for communication with another user.</p>
            </li>
            <li><p><strong>To request feedback.</strong> We may process your information when necessary to request feedback and to contact you about your use of our Services.</p>
            </li>
            <li><p><strong>To send you marketing and promotional communications.</strong> We may process the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt out of our marketing emails at any time. For more information, see “<a href="#privacyrights">WHAT ARE YOUR PRIVACY RIGHTS?</a>“ below).</p>
            </li>
            <li><p><strong>To deliver targeted advertising to you.</strong> We may process your information to develop and display personalized content and advertising tailored to your interests, location, and more.</p>
            </li>
            ...
            <li><p><strong>To prevent, detect and fight fraud and other illegal or unauthorized activities**</strong>.** To communicate with individuals who submitted reports and to use information to needed to find violators and to improve user security and safety.</p>
            </li>
            </ul>
            <h3 id="legalbases"><strong>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</strong></h3>
            ...
            <ul>
            <li><p><strong>Consent.</strong> We may process your information if you have given us permission (i.e., consent) to use your personal information for a specific purpose. You can withdraw your consent at any time. Click <a href="#withdrawconsent">here</a> to learn more.</p>
            </li>
            <li><p><strong>Performance of a Contract.</strong> We may process your personal information when we believe it is necessary to fulfill our contractual obligations to you, including providing our Services or at your request prior to entering into a contract with you.</p>
            </li>
            ...
            <li><p>Send users information about special offers and discounts on our products and services</p>
            </li>
            <li><p>Develop and display personalized and relevant advertising content for our users</p>
            </li>
            <li><p>Analyze how our services are used so we can improve them to engage and retain users</p>
            </li>
            <li><p>Support our marketing activities</p>
            </li>
            <li><p>Diagnose problems and/or prevent fraudulent activities</p>
            </li>
            <li><p>Understand how our users use our products and services so we can improve user experience</p>
            </li>
            <li><p>protect our Users and third parties from harm</p>
            </li>
            ...
            <ul>
            <li><p>If collection is clearly in the interests of an individual and consent cannot be obtained in a timely way</p>
            </li>
            <li><p>For investigations and fraud detection and prevention</p>
            </li>
            <li><p>For business transactions provided certain conditions are met</p>
            </li>
            <li><p>If it is contained in a witness statement and the collection is necessary to assess, process, or settle an insurance claim</p>
            </li>
            <li><p>For identifying injured, ill, or deceased persons and communicating with next of kin</p>
            </li>
            <li><p>If we have reasonable grounds to believe an individual has been, is, or may be victim of financial abuse</p>
            </li>
            <li><p>If it is reasonable to expect collection and use with consent would compromise the availability or the accuracy of the information and the collection is reasonable for purposes related to investigating a breach of an agreement or a contravention of the laws of Canada or a province</p>
            </li>
            <li><p>If disclosure is required to comply with a subpoena, warrant, court order, or rules of the court relating to the production of records</p>
            </li>
            <li><p>If it was produced by an individual in the course of their employment, business, or profession and the collection is consistent with the purposes for which the information was produced</p>
            </li>
            <li><p>If the collection is solely for journalistic, artistic, or literary purposes</p>
            </li>
            <li><p>If the information is publicly available and is specified by the regulations</p>
            </li>
            </ul>
            <h3 id="whoshare"><strong>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</strong></h3>
            ...
            <ul>
            <li><p>Website Hosting Service Providers</p>
            </li>
            <li><p>User Account Registration &amp; Authentication Services</p>
            </li>
            <li><p>Testing Tools</p>
            </li>
            <li><p>Social Networks</p>
            </li>
            <li><p>Sales &amp; Marketing Tools</p>
            </li>
            <li><p>Retargeting Platforms</p>
            </li>
            <li><p>Product Engineering &amp; Design Tools</p>
            </li>
            <li><p>Performance Monitoring Tools</p>
            </li>
            <li><p>Payment Processors</p>
            </li>
            <li><p>Order Fulfillment Service Providers</p>
            </li>
            <li><p>Government Entities</p>
            </li>
            <li><p>Finance &amp; Accounting Tools</p>
            </li>
            <li><p>Data Storage Service Providers</p>
            </li>
            <li><p>Data Analytics Services</p>
            </li>
            <li><p>Communication &amp; Collaboration Tools</p>
            </li>
            <li><p>Cloud Computing Services</p>
            </li>
            <li><p>Affiliate Marketing Programs</p>
            </li>
            <li><p>Ad Networks</p>
            </li>
            </ul>
            ...
            <li><p><strong>When we use Google Maps Platform APIs.</strong> We may share your information with certain Google Maps Platform APIs (e.g., Google Maps API, Places API). To find out more about Google’s Privacy Policy, please refer to this <a href="https://policies.google.com/privacy">link</a>. We use certain Google Maps Platform APIs to retrieve certain information when you make location-specific requests. This includes: city location; and other similar information. A full list of what we use information for can be found in this section and in the previous section titled “<a href="#infouse">HOW DO WE PROCESS YOUR INFORMATION?</a>“. We obtain and store on your device (“cache”) your location. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document. The Google Maps Platform APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein, and Norway) or the United Kingdom, please take a look at our Cookie Notice.</p>
            </li>
            <li><p><strong>Affiliates.</strong> We may share your information with our affiliates, in which case we will require those affiliates to honor this privacy notice. Affiliates include our parent company and any subsidiaries, joint venture partners, or other companies that we control or that are under common control with us.</p>
            </li>
            ...
            <li><p><strong>Other Users.</strong> When you share personal information (for example, by posting comments, contributions, or other content to the Services) or otherwise interact with public areas of the Services, such personal information may be viewed by all users and may be publicly made available outside the Services in perpetuity. If you interact with other users of our Services and register for our Services through a social network (such as Facebook), your contacts on the social network will see your name, profile photo, and descriptions of your activity. Similarly, other users will be able to view descriptions of your activity, communicate with you within our Services, and view your profile.</p>
            </li>
            <li><p><strong>Offer Wall.</strong> Our application(s) may display a third-party hosted “offer wall.” Such an offer wall allows third-party advertisers to offer virtual currency, gifts, or other items to users in return for the acceptance and completion of an advertisement offer. Such an offer wall may appear in our application(s) and be displayed to you based on certain data, such as your geographic area or demographic information. When you click on an offer wall, you will be brought to an external website belonging to other persons and will leave our application(s). A unique identifier, such as your user ID, will be shared with the offer wall provider in order to prevent fraud and properly credit your account with the relevant reward.</p>
            </li>
            </ul>
            <h3 id="cookies"><strong>5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</strong></h3>
            ...
            <h3 id="sociallogins"><strong>6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</strong></h3>
            ...
            <h3 id="inforetain"><strong>7. HOW LONG DO WE KEEP YOUR INFORMATION?</strong></h3>
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at admin@facets.one.</p>
            <h3 id="DNT"><strong>10. CONTROLS FOR DO-NOT-TRACK FEATURES</strong></h3>
            ...
            <h3 id="caresidents"><strong>11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></h3>
            ...
            <ul>
            <li><p>Receiving help through our customer support channels;</p>
            </li>
            <li><p>Participation in customer surveys or contests; and</p>
            </li>
            <li><p>Facilitation in the delivery of our Services and to respond to your inquiries.</p>
            </li>
            </ul>
            <p><strong>How do we use and share your personal information?</strong></p>
            <p>Facets LLC collects and shares your personal information through:</p>
            <ul>
            <li><p>Targeting cookies/Marketing cookies</p>
            </li>
            <li><p>Social media cookies</p>
            </li>
            <li><p>Beacons/Pixels/Tags</p>
            </li>
            </ul>
            <p>More information about our data collection and sharing practices can be found in this privacy notice.</p>
            <p>You may contact us by email at admin@facets.one, by visiting <a href="http://www.facets.one/contact-us">http://www.facets.one/contact-us</a>, or by referring to the contact details at the bottom of this document.</p>
            ...
            <p>Facets LLC has not sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Facets LLC has disclosed the following categories of personal information to third parties for a business or commercial purpose in the preceding twelve (12) months:</p>
            <ul>
            <li><p>Category A. Identifiers, such as contact details like your real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name.</p>
            </li>
            <li><p>Category B. Personal information, as defined in the California Customer Records law, such as your name, contact information, education, employment, employment history, and financial information.</p>
            </li>
            <li><p>Category C. Characteristics of protected classifications under California or federal law, such as gender or date of birth.</p>
            </li>
            <li><p>Category D. Commercial information, such as transaction information, purchase history, financial details, and payment information.</p>
            </li>
            <li><p>Category E. Biometric information, such as fingerprints and voiceprints.</p>
            </li>
            <li><p>Category F. Internet or other electronic network activity information, such as browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements.</p>
            </li>
            <li><p>Category G. Geolocation data, such as device location.</p>
            </li>
            <li><p>Category H. Audio, electronic, visual, and similar information, such as images and audio, video, or call recordings created in connection with our business activities.</p>
            </li>
            <li><p>Category I. Professional or employment-related information, such as business contact details in order to provide you our services at a business level or job title, work history, and professional qualifications if you apply for a job with us.</p>
            </li>
            <li><p>Category J. Education information, such as student records and directory information.</p>
            </li>
            </ul>
            ...
            <ul>
            <li><p>whether we collect and use your personal information;</p>
            </li>
            <li><p>the categories of personal information that we collect;</p>
            </li>
            <li><p>the purposes for which the collected personal information is used;</p>
            </li>
            <li><p>whether we sell your personal information to third parties;</p>
            </li>
            <li><p>the categories of personal information that we sold or disclosed for a business purpose;</p>
            </li>
            <li><p>the categories of third parties to whom the personal information was sold or disclosed for a business purpose; and</p>
            </li>
            <li><p>the business or commercial purpose for collecting or selling personal information.</p>
            </li>
            </ul>
            ...
            <ul>
            <li><p>You may object to the processing of your personal information.</p>
            </li>
            <li><p>You may request correction of your personal data if it is incorrect or no longer relevant, or ask to restrict the processing of the information.</p>
            </li>
            <li><p>You can designate an authorized agent to make a request under the CCPA on your behalf. We may deny a request from an authorized agent that does not submit proof that they have been validly authorized to act on your behalf in accordance with the CCPA.</p>
            </li>
            <li><p>You may request to opt out from future selling of your personal information to third parties. Upon receiving an opt-out request, we will act upon the request as soon as feasibly possible, but no later than fifteen (15) days from the date of the request submission.</p>
            </li>
            </ul>
            <p>To exercise these rights, you can contact us by email at admin@facets.one, by visiting <a href="http://www.facets.one/contact-us">http://www.facets.one/contact-us</a>, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
            <h3 id="policyupdates"><strong>12. DO WE MAKE UPDATES TO THIS NOTICE?</strong></h3>
            ...
            <h3 id="contact"><strong>13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</strong></h3>
            <p>If you have questions or comments about this notice, you may email us at admin@facets.oneor by post to:</p>
            <p>Facets LLC</p>
            <p>1 Daniel Burnham Court, apt 106</p>
            <p>apt 106</p>
            <p>San Francisco, CA 94109</p>
            <p>United States</p>
            <h3 id="request"><strong>14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</strong></h3>
            <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please submit a request form by clicking <a href="https://app.termly.io/notify/1b9fadd6-d915-4e56-b2b0-794aa59417d7">here</a>.</p>
            {/* <p>ul { list-style-type: square; } ul &gt; li &gt; ul { list-style-type: circle; } ul &gt; li &gt; ul &gt; li &gt; ul { list-style-type: square; } ol li { font-family: Arial ; }</p> */}
